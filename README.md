...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-27 14:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/fd15f55b-f776-440e-92f8-9415d4e4911f.git
$ cd fd15f55b-f776-440e-92f8-9415d4e4911f
```
